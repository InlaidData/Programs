...
public class RacingScore2
{
	...
	{
		int s, s1, s2;
		if (score1 <= score2 && score1 <= score3) //Changed < to <=
		{
			s1 = score2;
			s2 = score3;
		}
		else if (score2 <= score1 && score2 <= score3)//Changed all three to less than OR equal too. 
		{
			s1 = score1;
			s2 = score3; //This was set as score2, should be score 3 to capture the largest.
		}
		else //score3 must the the smallest at this point.
		{
			s1 = score1;
			s2 = score2;
		}
